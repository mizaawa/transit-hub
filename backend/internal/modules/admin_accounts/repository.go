...
var workspaceDeleteStatements = []workspaceDeleteStatement{
	...
	{Name: "connection_health_account_multipliers", SQL: `DELETE FROM connection_health_account_multipliers WHERE user_id = $1 AND admin_account_id = $2`},
...
var legacyWorkspaceTables = []workspaceTableDescriptor{
	...
	{Name: "connection_health_account_multipliers", WorkspaceColumn: "admin_account_id"},
